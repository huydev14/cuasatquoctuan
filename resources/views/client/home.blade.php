...
<body class="bg-slate-50 font-['Inter',sans-serif] text-slate-900 antialiased">
    ...
    <section id="about-us"
        class="relative min-h-screen bg-gradient-to-br from-sky-50 to-slate-100 px-4 py-24 text-slate-900 sm:px-6 lg:px-12 flex items-center">
        <div class="mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center w-full">
            <div class="space-y-6">
                ...
                <a href="#bao-gia"
                    class="inline-flex mt-4 items-center justify-center rounded-full bg-amber-400 px-6 py-3 text-sm font-bold uppercase tracking-[0.06em] text-slate-900 transition hover:brightness-95">Nhận
                    tư vấn ngay</a>
            </div>
    ...
    <section id="featured-projects" class="bg-slate-50 px-4 py-24 sm:px-6 lg:px-12">
    ...
    <section id="contact" class="bg-white px-4 py-24 text-slate-900 sm:px-6 lg:px-12">
        <div class="mx-auto max-w-2xl">
            ...
            <p
                class="hero-reveal hero-reveal-delay-1 text-lg leading-8 text-slate-600 text-center mb-12 max-w-2xl mx-auto">
                Hãy gửi yêu cầu của bạn và chúng tôi sẽ liên hệ với bạn sớm nhất có thể.
            </p>

            <form method="POST" action="{{ route('contact.store') }}"
                class="hero-reveal hero-reveal-delay-2 space-y-6 bg-slate-50 p-8 rounded-2xl border border-slate-200">
                @csrf
